 ...
 * Copied from NetCDF libs because this class is not public.
 *
...
class EnhanceScaleMissingImpl implements EnhanceScaleMissing {
  ...
  private boolean useNaNs = NetcdfDataset.getUseNaNs();
  private boolean invalidDataIsMissing = NetcdfDataset.getInvalidDataIsMissing();
  private boolean fillValueIsMissing = NetcdfDataset.getFillValueIsMissing();
  private boolean missingDataIsMissing = NetcdfDataset.getMissingDataIsMissing();
  ...
  public EnhanceScaleMissingImpl( VariableDS forVar) {
    this(forVar, NetcdfDataset.getUseNaNs(), NetcdfDataset.getFillValueIsMissing(),
         NetcdfDataset.getInvalidDataIsMissing(), NetcdfDataset.getMissingDataIsMissing());
  }
