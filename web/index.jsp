...
<html>
    ...
    <a href="./WMS?SERVICE=WMS&REQUEST=GetMap&VERSION=<%=WMS.VERSION%>&LAYERS=sdfsdf&STYLES=&CRS=<%=WMS.CRS_84%>&BBOX=0,0,90,90&WIDTH=100&HEIGHT=100&FORMAT=image/png">GetMap</a><br />
